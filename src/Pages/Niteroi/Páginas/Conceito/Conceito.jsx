...
import NavbarRj from '../../Componentes/navbar/navbar'; 
            ...
            <article className={Styles.Article}>
                ...
                <div>
                    ...
                    <img 
                        ...
                        src={require("../../Componentes/Images/Conceito/20230703_183843917_iOS-1536x748.jpg")} 
                ...
                <div className={Styles.Subject}>
                    ...
                    <img 
                        className={Styles.Image}
                        src={require("../../Componentes/Images/Conceito/SalasDeCinema.jpg")} 
                ...
                <div className={Styles.Subject}>
                    ...
                    <Slider className={Styles.Slider} {...sliderSettings}>
                        <div>
                            <img src={require('../../Componentes/Images/Gastronomia/FileDePeixeNaCrostaDeAlho.jpg')} alt="Prato gourmet composto por filé de peixe com crosta de alho servido ao lado de risoto cremoso de espinafre, decorado com uma pequena pimenta vermelha no topo. A apresentação está em um prato escuro sobre uma mesa de madeira." />
                        </div>
                        <div>
                            <img src={require('../../Componentes/Images/Gastronomia/PicadinhodeCarne.jpg')} alt="" />
                        </div>
                        <div>
                            <img src={require('../../Componentes/Images/Gastronomia/Galeto.jpg')} alt="" />
                        </div>
                        <div>
                            <img src={require('../../Componentes/Images/Gastronomia/Fotografia.jpg')} alt="" />
                        </div>
                        <div>
                            <img src={require('../../Componentes/Images/Gastronomia/MenuReserva.jpg')} alt="" />
                        </div>
                    </Slider>
                ...
                <div className={Styles.Subject}>
                    ...
                    <img className={Styles.Image} src={require('../../Componentes/Images/Conceito/ReservaNiteroi.jpg')} alt="Fachada moderna do cinema Reserva Cultural, com uma ampla estrutura de vidro e entrada principal. Pessoas estão sentadas em mesas ao ar livre no terraço do local." />
